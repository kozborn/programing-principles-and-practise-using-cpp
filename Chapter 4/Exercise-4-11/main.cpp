...
int main()
{
    cout << "Exercise 4.11" << endl;
    cout << "Create a program to find all the prime numbers between 1 and 100. One" <<
            ...
            "of prime numbers with primes . Consider 2 the first prime." << endl << endl;
