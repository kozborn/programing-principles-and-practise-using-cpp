/* Write a program that prompts the user to enter two doubleeger values. Store
 * these values in double variables named val1 and val2 . Write your program to
...
int main()
{
    cout << "Program for calculating: \nsmaller, larger, sum, difference, product and ratio of two 'double' values!" << endl;
    double v1 = 0, v2 = 0;
    ...
    cout << "Ratio: " << v1 << " / " << v2 << " = " << int(v1 / v2) << endl;
